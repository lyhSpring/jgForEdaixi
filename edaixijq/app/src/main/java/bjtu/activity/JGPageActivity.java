...
public class JGPageActivity extends ActivityGroup {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jgpage);
    ...
    private void createView(){
        //create xiyi view
        Intent xiyiIntent = new Intent(JGPageActivity.this,WaitingActivity.class);
        xiyiIntent.putExtra("userID",userID);
        xiyiIntent.putExtra("regionID",regionID);
        xiyiPTView = this.getLocalActivityManager().startActivity("xiyiPTView",xiyiIntent)
                .getDecorView();
        xiyiPTView.setTag(0);
        viewList.add(xiyiPTView);
        //create order view
        Intent orderIntent = new Intent(JGPageActivity.this,OrderActivity.class);
        orderIntent.putExtra("userID",userID);
        orderIntent.putExtra("regionID",regionID);
        ...
        //create myself view
        Intent myIntent = new Intent(JGPageActivity.this,MyselfActivity.class);
        myIntent.putExtra("userID",userID);
        myIntent.putExtra("regionID",regionID);
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (keyCode == KeyEvent.KEYCODE_BACK) {
            if (keyCode == KeyEvent.KEYCODE_BACK) {
                Builder builder = new Builder(JGPageActivity.this);
                builder.setTitle("提示");
